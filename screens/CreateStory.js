...
import {TextInput, Text, View, Image, StyleSheet, SafeAreaView, Platform, StatusBar, Dimensions,ScrollView } from "react-native";
	...
	render() {
      ...
      let preview_images={
       ...
       onOpen={()=>{
        ...
        <TextInput
            style={[styles.inputFont,{marginTop:20}]}
